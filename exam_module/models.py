...
class Exam(models.Model):
    ...
    duration = models.DurationField(verbose_name=_("مدت زمان"), null=False, blank=False)
    ...
    modify_date = models.DateTimeField( verbose_name=_("تاریخ ویرایش"), auto_now=True)
...
class ExamResult(models.Model):
    correct_answers = models.IntegerField(verbose_name=_("جواب های درست"))
    incorrect_answers = models.IntegerField(verbose_name=_("جواب های نادرست"))
    is_active = models.BooleanField(verbose_name=_("فعال / غیرفعال"), default=True, db_index=True)
